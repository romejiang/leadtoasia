                ...
                <table>
                    ...
                    <g:each in="${pricingInstanceList}" status="i" var="pricingInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:link action="show" controller="pricing" id="${pricingInstance.id}" params="[pid: pid , parentType : parentType]">${fieldValue(bean: pricingInstance, field: "source")} - ${fieldValue(bean: pricingInstance, field: "target")}</g:link></td>
