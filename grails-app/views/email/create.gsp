                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="mail"><g:message code="email.mail.label" default="Mail" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: emailInstance, field: 'mail', 'errors')}">
                                    <g:textField name="mail" maxlength="250" value="${emailInstance?.mail}" />
                                </td>
                            </tr>
