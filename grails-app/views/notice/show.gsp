            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="notice.name.label" default="Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: noticeInstance, field: "name")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="notice.content.label" default="Content" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: noticeInstance, field: "content")}</td>
