    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="processing" value="Send Back Notice" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');"/></span>
                </div>
            </g:form>
        </div>
    </body>
